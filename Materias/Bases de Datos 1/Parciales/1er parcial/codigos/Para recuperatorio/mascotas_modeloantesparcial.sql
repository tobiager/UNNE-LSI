...
CREATE DATABASE veterinaria215;
...
(
  ...
  CONSTRAINT FK_especie_id_especie1 FOREIGN KEY (id_especie) REFERENCES especie(id_especie)
);
...
--RESTRICCIONES
--verifica que dni sea menor o igual a 8
ALTER TABLE dueno ADD CONSTRAINT CK_dueno_dni1 CHECK (LEN(dni) <= 8 AND isnumeric(dni) = 1);

--devuelve edad menor a 30
ALTER TABLE mascota ADD CONSTRAINT CK_mascota_edad CHECK (DATEDIFF(YEAR, fecha_nacimiento, GETDATE()) <= 30);

--registra fecha por defecto sistema
ALTER TABLE cita_medica ADD CONSTRAINT DF_cita_medica_cita_fecha DEFAULT getdate() FOR cita_fecha;

--registra usuario por defecto base de datos
...
(2, 'Vacunaci�n', 2, 2, '2024-09-24', 'usuario2');
...
(1, 'Antibi�tico', 7, 'Tomar con comida', 1),
...
--UQ
INSERT INTO dueno (id_dueno, dni, nombre, direccion, telefono, email) VALUES
(3, 12345678, 'Juan Perez', 'Calle Falsa 123', '1234-5678', 'juan.perez@example.com');

--NULL
INSERT INTO dueno (id_dueno, dni, nombre, direccion, telefono, email) VALUES
(3, 12345678, NULL, 'Calle Falsa 123', '1234-5678', 'juan.perez@example.com');

--CHECK
INSERT INTO mascota (id_mascota, nombre, fecha_nacimiento, peso, condicion_medica_especial, id_dueno, id_especie) VALUES
(5, 'Firulais', '1900-01-01', 20, 'Ninguna', 1, 1);

--default 
INSERT INTO cita_medica (id_cita, motivo, id_mascota, nro_licencia_profesional, usuario) VALUES
(80, 'Chequeo general', 1, 1, 'usuario1');

--fk
INSERT INTO raza (raza, id_especie) VALUES
('Labrador', 10);

--otra opcion para fecha por defecto
/*
