CREATE DATABASE modelo_parcial_v2;
GO
USE modelo_parcial_v2;
GO
...
(
  ...
  dni_duenio VARCHAR(30) NOT NULL,
  ...
  CONSTRAINT UQ_Dueno_dni UNIQUE(dni_duenio)
);
...
INSERT INTO Dueno (id_dueno, nombre_duenio, apellido_duenio, direccion_duenio, dni_duenio, telefono_duenio, email_duenio ) VALUES
(4, 'Maria', 'Pérez', 'Calle Falsa 800', 1234567891011, 5551234, 'mariaperez454@example.com');