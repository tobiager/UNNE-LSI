//AUTOR 1: Orban, Tobias DNI:46385637
//AUTOR 2: Fernandez, Federico DNI:43677043
...
void calcularPorcentajeCaja1() {
    if (ventaCajaN1 > 0) { 
        porcentajeVentaCaja1 = (ventaCajaN1 * 100) / (ventaCajaN1 + ventaCajaN2 + ventaCajaN3);
    } else {
        porcentajeVentaCaja1 = 0;
    }
}
...
void mostrarInforme() {
    ...
    printf("Importe recaudado por ventas de caja Nro 1: $%.2f\n", ventaCajaN1);
    printf("Porcentaje de venta de Caja Nro 1 sobre el total de las ventas de las otras cajas: %.2f%%\n", porcentajeVentaCaja1);
}
