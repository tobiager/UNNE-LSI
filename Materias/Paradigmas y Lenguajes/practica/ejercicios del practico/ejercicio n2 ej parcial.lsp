...
(defun calcular-descuentos (mayores menores)
  ...
  (let* ((importeMayor 2500)
    ...
    (cond
      ...
      ((and (> mayores 150) (<= mayores 200)) (- totalSinDescuento (* 0.08 totalSinDescuento)))
...
"Ingresar cantidad de personas: " 300

"Ingresar cantidad de personas mayores: " 200

"Ingresar cantidad de personas menores: " 100

(SILLAS 100) Se pueden acomodar sin agregar SILLAS 
NIL 
598000.0 
598000.0
...
"Ingresar cantidad de personas: " 339

"Ingresar cantidad de personas mayores: " 229
