...
public class GestionComercio {
  public static void main(String[] args) {
    ...
    Empleado juan = new Empleado(30100623, "Gonzalez", "Juan", 120000,
        fechaIngreso);
    Empleado mercedes = new Empleado(37045987, "Martinez", "Mercedes", 100000,
        fechaIngreso);
    Empleado virginia = new Empleado(32550096, "Gomez", "Virginia", 150000,
        fechaIngreso);
    ...
    do {
      ...
      switch (opcion) {
        case 1:
          ...
          Empleado nuevoEmpleado = new Empleado(cuilEmpleado, apellidoEmpleado, nombreEmpleado, sueldoBasicoEmpleado,
