public class Producto {
   ...
   */
  public Producto(int pCodigo, String pRubro, String pDescripcion, double pCosto, double pPorcPtoRepo, int pExistMinima,
   ...
   * @param pLaboratorio Un objeto de la clase Laboratorio.
   */
  public Producto(int pCodigo, String pRubro, String pDescripcion, double pCosto, Laboratorio pLaboratorio) {
    this.setCodigo(pCodigo);
    this.setRubro(pRubro);
    this.setDescripcion(pDescripcion);
    this.setCosto(pCosto);
