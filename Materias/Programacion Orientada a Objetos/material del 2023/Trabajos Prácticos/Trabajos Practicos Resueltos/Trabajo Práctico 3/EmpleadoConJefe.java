...
/**
 * Ejercicio 12, clase EmpleadoConJefe.
 * 
...
public class EmpleadoConJefe {
   ...
   * @param pFechaIngreso La fecha que ingreso el empleado tipo Calendar.
   * @param pJefe         Si es que tiene un jefe de tipo EmpleadoConJefe.
   */
  EmpleadoConJefe(long pCuil, String pApellido, String pNombre, double pSueldoBasico, Calendar pFechaIngreso,
      EmpleadoConJefe pJefe) {
    this.setCuil(pCuil);
   ...
   * @param pNombre       El nombre del empleado.
   * @param pSueldoBasico El sueldo basico del empleado.
   * @param pAnioIngreso  Año de ingreso int.
   */
  EmpleadoConJefe(long pCuil, String pApellido, String pNombre, double pSueldoBasico, int pAnioIngreso) {
    this.setCuil(pCuil);
    this.setApellido(pApellido);
    this.setNombre(pNombre);
    this.setSueldoBasico(pSueldoBasico);
  ...
  private void setJefe(EmpleadoConJefe pJefe) {
    this.jefe = pJefe;
  }
   ...
   * salario neto del empleado y si tiene jefe el nombre si no es Gerente General.
   */
  public void mostrar() {
    ...
    System.out.println(
        String.format("Responde a: %s", this.getJefe() != null ? this.getJefe().apeYNom() : "Gerente General"));
  }
