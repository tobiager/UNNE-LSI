...
public class Organizacion {
    public static void main(String[] args) {
        ...
        // Datos del empleado sin jefe (Gerente General)
        ...
        fechaIngresoGerente.set(Calendar.MONTH, 0); // Asumir enero como mes de ingreso
        fechaIngresoGerente.set(Calendar.DAY_OF_MONTH, 1); // Asumir el primer día del mes
        ...
        fechaIngresoEmpleado.set(Calendar.MONTH, 0); // Asumir enero como mes de ingreso
        fechaIngresoEmpleado.set(Calendar.DAY_OF_MONTH, 1); // Asumir el primer día del mes
